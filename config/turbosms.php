...
return [
     ...
     * Выдается на после регистрации на странице настроек шлюза
     */
    'api_key' => env('TURBOSMS_API_KEY', '77ad51dbc3e22793edc486ee33b174f1c50e7dff'),
     ...
     */
    'sms_sender' => env('TURBOSMS_SMS_SENDER', 'Dostavka24'),
     ...
     * Supported: "Mobibon"
     */
    'viber_sender' => env('TURBOSMS_VIBER_SENDER', 'Tisto'),
